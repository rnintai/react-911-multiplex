...
class Movie_info extends Component {
  ...
  getData = async() =>{       //  데이터불러오기
    let MovieInfo = await axios.get('https://react-911-multiplex.herokuapp.com/movies/detail/20210865');
    ...
    return (
      <div>
        <section>
          ...
          <p className="Info">장르 : {this.state.MovieInfo.genre} 개봉 : {this.state.MovieInfo.released_at}러닝타임 : {this.state.MovieInfo.running_time}분</p>
